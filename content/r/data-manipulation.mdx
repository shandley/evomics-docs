...
For hands-on exercises, see [Lesson 3](https://github.com/shandley/R-tutorials/blob/main/lesson03_data_transformation.Rmd) and [Lesson 4](https://github.com/shandley/R-tutorials/blob/main/lesson04_grouping_summarizing.Rmd) of the full course.
</Callout>
