...
ggplot2 builds plots using a systematic, layered approach based on the Grammar of Graphics:
...
Essential plot types for exploratory data analysis and publication.
...
![Histogram example showing distribution of penguin body mass](/images/r/histogram.png)
...
![Line plot showing bacterial growth over time](/images/r/lineplot.png)

## Aesthetics (aes)

Aesthetics map your data variables to visual properties of the plot:
...
Enhance plots with statistical transformations and summaries:
