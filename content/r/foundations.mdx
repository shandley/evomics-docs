...
For hands-on exercises and detailed tutorials, see [Lesson 1](https://github.com/shandley/r-tidyverse-for-biologists/blob/main/lesson01_intro_to_R_and_RMarkdown.Rmd) and [Lesson 2](https://github.com/shandley/r-tidyverse-for-biologists/blob/main/lesson02_data_import_exploration.Rmd) of the full course.
</Callout>

## R Basics

R provides a powerful environment for biological data analysis. Let's start with the fundamentals.
...
Vectors store multiple values of the same type and are essential for biological measurements.
...
The tidyverse is a collection of R packages for data science with a consistent design philosophy and grammar.
...
Working with external data files is essential for real-world analysis.
...
Essential functions for understanding your datasets.
...
Basic ggplot2 syntax for exploratory data visualization:
...
![Histogram showing distribution of penguin body mass](/images/r/histogram.png)
...
![Boxplot comparing body mass across three penguin species](/images/r/boxplot.png)
...
![Scatterplot showing relationship between flipper length and body mass, colored by species](/images/r/scatterplot.png)
...
When working with new data, follow this systematic approach:
...
Essential code patterns for biological data analysis.
...
- [Full Interactive Course](https://github.com/shandley/r-tidyverse-for-biologists) - Hands-on exercises and homework
