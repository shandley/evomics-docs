---
title: Foundations
description: Essential UNIX concepts and commands for bioinformatics
---
...
<Callout type="info" title="Practice: Tab Completion">
...
<Callout title="Reading Manual Pages">
...
<Callout type="info" title="Staying Oriented">
...
<Callout type="info" title="Counting Sequences in FASTA">
...
<Callout type="warn" title="Copying Large Files">
...
<Callout type="error" title="Dangerous Command!">
...
<Callout title="Exercise 1: Navigation">
...
<Callout title="Exercise 2: Viewing Files">
...
Now that you understand the basics, practice on [Evomics Learn](https://learn.evomics.org/terminal) to reinforce these concepts.
